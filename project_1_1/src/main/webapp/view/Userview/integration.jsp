...
<div class="margin clearfix">
 ...
 <div class="search_style">
	...
	<c:forEach var="record" items="${RecordList}">
        ...
        <td>${record.id}</td>
        <td>${record.r_uname}</td>
        <td><a href="javascript:ovid()" onclick="integration_history('23')">${record.rintegral}</a></td>
        <td><a href="javascript:ovid()" onclick="Browse_history('13')">${record.rview}</a></td>
        <td><a href="javascript:ovid()" onclick="Order_history('33')">${record.rpencent}</a></td>
        <td> <a title="删除" href="javascript:;"  onclick="member_del(this,${record.id})" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a></td>
        </tr>
    </c:forEach>
        </tbody>    
     </table>     
