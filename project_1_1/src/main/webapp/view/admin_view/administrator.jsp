...
<body>
	<div class="page-content clearfix">
		<div class="administrator">
			<div class="d_Confirm_Order_style">
				...
				<form action="<%=basePath%>admin/selectAdminByInfo" method="post">
					<ul class="search_content clearfix">
						<li><label class="l_f">管理员名称</label><input name="a_username"
							type="text" class="text_add" placeholder="" style=" width:400px" /></li>
						<li><label class="l_f">添加时间</label><input name="a_registerTime"
							class="inline laydate-icon" id="start" style=" margin-left:10px;"></li>
						<li style="width:90px;"><button type="submit"
								class="btn_search" id="btn_searchid">
				...
				<div class="border clearfix">
					...
					</span> <span class="r_f">共：<b><c:out value="${fn:length(adminList)}"></c:out></b>人
					</span>
				</div>
				<!--管理员列表-->
								...
								<tr>
									...
									<td class="td-manage"><a
										...
										title="停用" class="btn btn-xs btn-success"><i
											class="fa fa-check  bigger-120"></i></a> <a title="用户信息修改"
										onclick="member_edit('编辑','<%=basePath%>admin/modifyAdminInfo?a_id='+'${admin.a_id }','','700','510')"
										href="javascript:;" class="btn btn-xs btn-info"><i
											class="fa fa-edit bigger-120"></i></a> <a title="删除"
										href="javascript:;" onclick="member_del(this,${admin.a_id})"
	...
	<div id="add_administrator_style" class="add_menber"
		style="display:none">
		<form action="<%=basePath%>admin/insertAdmin" method="post"
			id="form-admin-add">
			...
			<div class="form-group">
				...
				<div class="formControls">
					<input type="password" placeholder="密码" name="adminpassword"
			...
			<div class="form-group">
				...
				<div class="formControls ">
					<input type="password" placeholder="确认新密码" autocomplete="off"
						...
						datatype="*" nullmsg="请再输入一次新密码！" recheck="adminpassword"
						id="newpassword2" name="a_password">
				</div>
				<div class="col-4">
					<span class="Validform_checktip"></span>
				</div>
			...
			<div class="form-group">
				...
				<div class="formControls  skin-minimal">
					 <label><input name="a_sex" type="radio" class="ace"
						checked="checked" value="女"><span class="lbl">女</span></label>&nbsp;&nbsp; 
					<label><input name="a_sex" type="radio" class="ace" value="男"><span
						class="lbl">男</span></label>&nbsp;&nbsp; <label>
<!-- 						<input name="a_sex" type="radio" class="ace"><span class="lbl" value="女">女</span></label>
 -->				</div>
				<div class="col-4">
					<span class="Validform_checktip"></span>
				</div>
...
<script type="text/javascript">
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			location.href="<%=basePath%>admin/deleteAdminById?a_id="+id;
		});
	}
	/*添加管理员*/
	...
	$(".fa fa-search").click(function(){
		location.hef="<%=basePath%>admin/selectAdminByInfo";
	}) --%>
</script>
