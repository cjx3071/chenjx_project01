     ...
     <table class="table table-striped table-bordered table-hover" id="sample-table">
       <thead>
        ...
        <tr>
          ...
          <td>${store.sclass}</td>
           <td>${store.stype}</td>
         <td class="displayPart" displayLength="80">${store.sinfo}</td>
         <td>${store.stime}</td>
          <td>${store.sstate}</td>
          <td class="td-manage">
           <a title="店铺详细" href="<%=basePath%>store/selectStoreById?sid=${store.sid}" class="btn btn-xs btn-info Refund_detailed">详细</a>        
