...
%>
 ...
 D XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <em class="type"></em>
  <div class="shop_logo"><img src="images/detailnoimg.png" /></div>
   <ul class="shop_content clearfix">
    <li class="shop_name"><label class="label_name">店铺名称：</label><span class="info">课程猫旗舰店</span> 
    <div class="Authenticate"><i class="icon-yxrz"></i><i class="icon-yhk"></i><i class="icon-sjrz"></i><i class="icon-grxx"></i></div></li>
    <li><label class="label_name">店铺类型：</label><span class="info">企业店铺</span></li>
    <li><label class="label_name">店铺分类：</label><span class="info">食品保健</span></li>
    ...
    <li><label class="label_name">申请人姓名：</label><span class="info">刘成阳</span></li>
...
parent.layer.iframeAuto(index);
 function through_save(obj,id){
	 layer.confirm('确认要开通该店铺吗？',function(index){
		...
		location.href="<%=basePath%>store/selectadoptStore";
