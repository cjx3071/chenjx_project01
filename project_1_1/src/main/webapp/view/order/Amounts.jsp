...
<div class="margin clearfix">
 <div class="amounts_style">
   <div class="transaction_Money clearfix">
      <div class="Money"><span >成交总额：${allmoney }元</span><p>最新统计时间:${otime }</p></div>
       <div class="Money"><span ><em>￥</em>${todaymoney }元</span><p>当天成交额</p></div>
    ...
    <div class="border clearfix">
      ...
      <a href="javascript:ovid()" id="todaybtn" class="btn btn-danger">当天订单</a>
        <a href="<%=basePath%>order/selectMonthOrder" class="btn btn-danger">当月订单</a>
       </span>
       <span class="r_f">共：<b>${successOrder }</b>笔</span>
     </div>
...
$(function(){
	$(".btn-info").on('click',function(){
		window.location.href="<%=basePath%>order/selectAllOrder";
	})
	
	$("#todaybtn").on('click',function(){
		window.location.href="<%=basePath%>order/selectTodayOrder";
	})
})
