...
<div class="margin clearfix">
 <div class="cover_style" id="cover_style">
   ...
   <div class="centent_style" id="centent_style">
     ...
     <form action="<%=basePath%>order/selectOrderById">
			...
			<td>${orderlist.price}</td>
			 ...
			 <td>
    			...
    			<!-- <a onClick="Delivery_stop(this,'10003')"  href="javascript:;" title="发货"  class="btn btn-xs btn-success"><i class="fa fa-cubes bigger-120"></i></a>  -->
     			<a title="订单详细"  href="<%=basePath%>order/selectDail?id=${orderlist.oid}" class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a> 
...
<%-- $(function(){
	$(".btn_search").click(function(){
		...
		window.location.href="<%=basePath%>order/selectOrderById?id=$('.text_add').val()";
	});
});
 --%>
 $(function() { 
