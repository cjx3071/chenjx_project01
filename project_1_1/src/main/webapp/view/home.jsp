...
<div class="page-content clearfix">
 <div class="alert alert-block alert-success">
  ...
  <i class="icon-ok green"></i>欢迎使用<strong class="green">后台管理系统<small>(v1.2)</small></strong>,你本次登陆时间为<span class="login_time"></span>，登陆IP:
  <%
...
.	
 ...
 <div class="clearfix">
  <div class="home_btn">
     ...
     <a href="<%=basePath %>admin/selectAdminInfo"  title="个人信息" class="btn  btn-success btn-sm no-radius">
