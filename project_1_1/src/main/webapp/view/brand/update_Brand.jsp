...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        ...
        <script type="text/javascript" src="<%=basePath%>Widget/swfupload/swfupload.js"></script>
        <script type="text/javascript" src="<%=basePath%>Widget/swfupload/swfupload.queue.js"></script>
        <script type="text/javascript" src="<%=basePath%>Widget/swfupload/swfupload.speed.js"></script>
        <script type="text/javascript" src="<%=basePath%>Widget/swfupload/handlers.js"></script>
</head>
...
<div class=" clearfix">
 ...
 <div class="left_add">
   ...
   <form action="<%=basePath%>bc/updateBrandById" enctype="multipart/form-data" method="Post">
   <ul class="add_conent">
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="brandname" type="text" class="add_text" value="<%=request.getParameter("brandname")%>"/></li>
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="brandId" type="text" class="add_text" style="width:80px" value="<%=request.getParameter("brandId")%>"/></li>
    <li class=" clearfix"><label class="label_name">品牌图片：</label>
           <div class="demo l_f">
	           <div class="logobox"><div class="resizebox"><img src="<%=basePath%>images/image.png" width="100px" alt="" height="100px"/></div></div>	
               <div class="logoupload">
                  <div class="btnbox"><a id="uploadBtnHolder" class="uploadbtn" href="javascript:;"><input name="brandimage" type="file"></a></div>
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="eachdistrict" type="text" class="add_text" style="width:120px" value="<%=request.getParameter("eachdistrict")%>"/></li>
         <li class=" clearfix"><label class="label_name">品牌描述：</label> <textarea name="branddescription" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
         <li class=" clearfix"><label class="label_name"><i>*</i>显示状态：</label> 
         <label><input name="according" type="radio" class="ace" checked="checked" value="显示"><span class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <label><input type="radio" class="ace" name="according" value="不显示"><span class="lbl">不显示</span></label>
         </li>
   </ul>
