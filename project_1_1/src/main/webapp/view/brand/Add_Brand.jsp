...
<div class=" clearfix">
 ...
 <div class="left_add">
   ...
   <form action="<%=basePath%>bc/upload" enctype="multipart/form-data" method="Post">
   <ul class="add_conent">
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="brandname" type="text" class="add_text"/></li>
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="brandId" type="text" class="add_text" style="width:80px"/></li>
    <li class=" clearfix"><label class="label_name">品牌图片：</label>
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="eachdistrict" type="text" class="add_text" style="width:120px"/></li>
         ...
         <label><input name="according" type="radio" class="ace" checked="checked" value="已启用"><span class="lbl">已启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <label><input type="radio" class="ace" name="according" value="已停用"><span class="lbl">已停用</span></label>
         </li>
   </ul>
