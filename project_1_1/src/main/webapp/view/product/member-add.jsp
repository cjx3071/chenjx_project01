...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">修改商品信息</div>
	...
	<form action="<%=basePath%>pc/updateProductById" method="post" class="form form-horizontal" id="form-article-add">
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>图片标题1：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name=""></div>
		</div>
		<div class=" clearfix cl">
         <label class="form-label col-2" for="productname">简略标题：</label>
	     <div class="formControls col-10"><input type="text" class="input-text" value="<%=request.getParameter("productname")%>" placeholder="" id="productname" name="productname"></div>
		</div>
		<div class=" clearfix cl">
			
			<div class="Add_p_s">
            <label class="form-label col-2" for="id">产品编号：</label>
			<div class="formControls col-2"><input type="text" class="input-text" value="<%=request.getParameter("id")%>" placeholder="" id="id" name="id"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2" for="eachdistrict">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="<%=request.getParameter("eachdistrict")%>" placeholder="" id="eachdistrict" name="eachdistrict"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2" for="material">材&nbsp;&nbsp;&nbsp;&nbsp;质：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="material" name="material"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2" for="brand">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="brand" name="brand"></div>
			</div>
             <div class="Add_p_s">
             <label class="form-label col-2" for="weight">产品重量：</label>	
            ...
            <div class="Add_p_s">
             <label class="form-label col-2" for="originalprice">原价格：</label>
			 <div class="formControls col-2"><input type="text" class="input-text" value="<%=request.getParameter("originalprice")%>" placeholder="" id="originalprice" name="originalprice" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2" for="nowtheprice">现价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="<%=request.getParameter("nowtheprice")%>" placeholder="" id="nowtheprice" name="nowtheprice" >元</div>
			</div>
		...
		<div class="clearfix cl">
			<label class="form-label col-2" for="keywords">关键词：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="keywords" name="keywords">
			</div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2" for="02">内容摘要：</label>
			<div class="formControls col-10">
