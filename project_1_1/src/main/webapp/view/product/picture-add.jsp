...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">添加商品</div>
	<form action="<%=basePath%>pc/newGoods" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
	     ...
	     <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="productname" name="productname"></div>
		</div>
		<div class=" clearfix cl">
			
			<div class="Add_p_s">
            <label class="form-label col-2" for="id">产品编号：</label>
			<div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="id" name="id"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2" for="eachdistrict">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="eachdistrict" name="eachdistrict"></div>
			</div>
            <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="originalprice" name="originalprice" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2" for="nowtheprice">现价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="nowtheprice" name="nowtheprice" >元</div>
			</div>
